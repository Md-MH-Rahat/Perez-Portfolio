      ...
      <div className="flex  justify-center text-center  gap-8 ">
        {tabs.map(tab => (
          <button
            ...
            className={`flex justify-center items-center rounded-[8px] gap-2 w-[152px] h-[56px] transition-colors duration-200 bg-[#FFFFFF] text-black text-[15px] font-sans font-bold ${
              activeTab === tab.id
                ? 'text-white bg-black '
        ...
        {activeTab === 'about' && (
          <div className="grid grid-cols-2">
            ...
            <div>
              ...
              <p className='text-[#08080899] pb-[30px] font-sans leading-[28px] w-[530px]'>Mark Henry, <span className='text-[#080808]'>Product Designer</span>, based in German. That is where I come in. A lover of words, a wrangler of copy. Here to create copy that not only reflects who you are and what you stand for,</p>
              <p className='text-[#08080899] pb-[32px] font-sans leading-[28px] w-[530px]'>
